  ...
  return (
    <div className="h-full bg-[#F1F5F8] flex flex-col justify-center items-center">
      <div className="bg-white w-full max-w-5xl rounded-2xl shadow-md p-6 md:p-10 m-2">
        ...
        <p className="text-[#2874DC] mb-6 text-[14px] md:text-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            <div className="flex-1">
              <label className="block text-[#2874DC] mb-1 text-sm font-medium">
                Job Title
              </label>
              <select
                className="w-full rounded-lg bg-[#f2f6fa] p-3 outline-none border border-transparent focus:border-[#2874DC] transition font-[400] text-black"
                value={jobTitle}
            ...
            <div className="flex-1">
              ...
              <input
                type="text"
                className="w-full rounded-lg bg-[#f2f6fa] p-3 outline-none border border-transparent focus:border-[#2874DC] transition text-black"
                placeholder="Company"
                value={company}
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-4 items-center">
            <div className="flex-1 w-full">
              ...
              <select
                className="w-full rounded-lg bg-[#f2f6fa] p-3 outline-none border border-transparent focus:border-[#2874DC] transition text-black font-[400]"
                value={startMonth}
            ...
            <div className="flex-1 w-full">
              ...
              <select
                className="w-full rounded-lg bg-[#f2f6fa] p-3 outline-none border border-transparent focus:border-[#2874DC] transition text-black text-black font-[400]"
                value={startYear}
            ...
            <div className="flex items-center mt-2 md:mt-7 ml-1">
              ...
              <span className="text-[#2874DC] text-sm select-none">
          ...
          <div className="mb-2">
            ...
            <textarea
              rows={4}
              className="w-full rounded-lg bg-[#f2f6fa] p-3 outline-none border border-transparent focus:border-[#2874DC] transition resize-none text-black"
          ...
          <div className="flex justify-end mt-6">
            <button
              type="submit"
              className="px-6 py-2 rounded-lg bg-[#2874DC] text-white font-semibold shadow hover:bg-[#0865FE] transition cursor-pointer"
            >
              Continue
            </button>
          </div>
      ...
      <div className="w-full flex justify-center items-center mt-4 text-sm">
        <a href="#" className="text-[#2874DC] hover:underline">
          Privacy Notice
        </a>
